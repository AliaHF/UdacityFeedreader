            ...
            expect(allFeeds).toBeDefined();
             for (var i = 0; i < allFeeds.length; i++) {
                ...
                expect(allFeeds[i].url).toEqual(jasmine.any(String));
                 expect(allFeeds[i].url.length).toBeGreaterThan(5);
...
/* TODO: Write a test that loops through each feed
   ...
   describe('The menu', function() {  
        ...
        loadFeed(0,function(){
          ...
          it('loadFeed has at least single entry elemnt' , function(){
 ...
 describe('The menu', function() { 
    ...
    it('when new feed is loaded, the content changed. ' , function(){
